...
I am a senior Computer Engineering student at Binghamton University with experience in Java, Python, TypeScript, JavaScript, C, C++, and SQL. I have built full-stack applications using React, Next.js, Node.js, Prisma, and PostgreSQL, including projects involving authentication, APIs, and database-backed workflows.

I want to strengthen my software engineering skills by working on real-world codebases, debugging issues, writing tests, and improving application reliability. I am particularly interested in backend development, full-stack development, and data-driven applications.

I prefer issues that involve software development and offer opportunities to learn. I would like to avoid FPGA, hardware, and embedded systems work, as well as tasks focused primarily on repetitive maintenance.
